...
func (p *kClient) ApiList(ctx context.Context, req *auth.ApiPageReq) (r *base.NilResponse, err error) {
...
func (p *kClient) ApiTree(ctx context.Context, req *auth.ApiPageReq) (r *base.NilResponse, err error) {
