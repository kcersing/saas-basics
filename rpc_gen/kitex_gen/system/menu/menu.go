...
func (p *MenuServiceClient) MenuTree(ctx context.Context, req *base.PageInfoReq) (r []*base.Tree, err error) {
...
var MenuServiceMenuTreeResult_Success_DEFAULT []*base.Tree

func (p *MenuServiceMenuTreeResult) GetSuccess() (v []*base.Tree) {
	if !p.IsSetSuccess() {
...
func (p *MenuServiceMenuTreeResult) Field0DeepEqual(src []*base.Tree) bool {
