...
func DeleteAt(v time.Time) predicate.VenuePlace {
	return predicate.VenuePlace(sql.FieldEQ(FieldDeleteAt, v))
}
...
func DeleteAtEQ(v time.Time) predicate.VenuePlace {
	return predicate.VenuePlace(sql.FieldEQ(FieldDeleteAt, v))
}

// DeleteAtNEQ applies the NEQ predicate on the "delete_at" field.
func DeleteAtNEQ(v time.Time) predicate.VenuePlace {
	return predicate.VenuePlace(sql.FieldNEQ(FieldDeleteAt, v))
}

// DeleteAtIn applies the In predicate on the "delete_at" field.
func DeleteAtIn(vs ...time.Time) predicate.VenuePlace {
	return predicate.VenuePlace(sql.FieldIn(FieldDeleteAt, vs...))
}

// DeleteAtNotIn applies the NotIn predicate on the "delete_at" field.
func DeleteAtNotIn(vs ...time.Time) predicate.VenuePlace {
	return predicate.VenuePlace(sql.FieldNotIn(FieldDeleteAt, vs...))
}

// DeleteAtGT applies the GT predicate on the "delete_at" field.
func DeleteAtGT(v time.Time) predicate.VenuePlace {
	return predicate.VenuePlace(sql.FieldGT(FieldDeleteAt, v))
}

// DeleteAtGTE applies the GTE predicate on the "delete_at" field.
func DeleteAtGTE(v time.Time) predicate.VenuePlace {
	return predicate.VenuePlace(sql.FieldGTE(FieldDeleteAt, v))
}

// DeleteAtLT applies the LT predicate on the "delete_at" field.
func DeleteAtLT(v time.Time) predicate.VenuePlace {
	return predicate.VenuePlace(sql.FieldLT(FieldDeleteAt, v))
}

// DeleteAtLTE applies the LTE predicate on the "delete_at" field.
func DeleteAtLTE(v time.Time) predicate.VenuePlace {
	return predicate.VenuePlace(sql.FieldLTE(FieldDeleteAt, v))
}
