...
const (
	// Label holds the string label denoting the courserecordmember type in the database.
	Label = "course_record_member"
	...
	// FieldMemberProductItemID holds the string denoting the member_product_item_id field in the database.
	FieldMemberProductItemID = "member_product_item_id"
	...
	// Table holds the table name of the courserecordmember in the database.
	Table = "course_record_member"
	// ScheduleTable is the table that holds the schedule relation/edge.
	ScheduleTable = "course_record_member"
...
// Columns holds all SQL columns for courserecordmember fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the CourseRecordMember queries.
...
// ByMemberProductItemID orders the results by the member_product_item_id field.
func ByMemberProductItemID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldMemberProductItemID, opts...).ToFunc()
}
