...
func (vq *VenueQuery) loadPlaces(ctx context.Context, query *VenuePlaceQuery, nodes []*Venue, init func(*Venue), assign func(*Venue, *VenuePlace)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(venue.PlacesTable)
		s.Join(joinT).On(s.C(venueplace.FieldID), joinT.C(venue.PlacesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(venue.PlacesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(venue.PlacesPrimaryKey[0]))
