...
var (
	...
	SysMenusColumns = []*schema.Column{
		...
		{Name: "sort", Type: field.TypeInt64, Comment: "sort | 排序编号", Default: 0},
...
func init() {
	...
	EntryLogsTable.ForeignKeys[1].RefTable = SysUsersTable
	...
	MemberContractTable.ForeignKeys[1].RefTable = OrderTable
