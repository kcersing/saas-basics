...
func (oiq *OrderItemQuery) QueryAufk() *OrderQuery {
...
func (oiq *OrderItemQuery) WithAufk(opts ...func(*OrderQuery)) *OrderItemQuery {
	query := (&OrderClient{config: oiq.config}).Query()
...
func (oiq *OrderItemQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OrderItem, error) {
	...
	if query := oiq.withAufk; query != nil {
		if err := oiq.loadAufk(ctx, query, nodes, nil,
			func(n *OrderItem, e *Order) { n.Edges.Aufk = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (oiq *OrderItemQuery) loadAufk(ctx context.Context, query *OrderQuery, nodes []*OrderItem, init func(*OrderItem), assign func(*OrderItem, *Order)) error {
