...
func (e OrderAmountEdges) AufkOrErr() (*Order, error) {
	if e.loadedTypes[0] {
		if e.Aufk == nil {
...
// QueryAufk queries the "aufk" edge of the OrderAmount entity.
func (oa *OrderAmount) QueryAufk() *OrderQuery {
	return NewOrderAmountClient(oa.config).QueryAufk(oa)
}
