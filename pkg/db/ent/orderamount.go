...
func (e OrderAmountEdges) OwnerOrErr() (*Order, error) {
	if e.loadedTypes[0] {
		if e.Owner == nil {
...
// QueryOwner queries the "owner" edge of the OrderAmount entity.
func (oa *OrderAmount) QueryOwner() *OrderQuery {
	return NewOrderAmountClient(oa.config).QueryOwner(oa)
}
