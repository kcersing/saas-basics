...
func (e OrderSalesEdges) OwnerOrErr() (*Order, error) {
	if e.loadedTypes[0] {
		if e.Owner == nil {
...
// QueryOwner queries the "owner" edge of the OrderSales entity.
func (os *OrderSales) QueryOwner() *OrderQuery {
	return NewOrderSalesClient(os.config).QueryOwner(os)
}
