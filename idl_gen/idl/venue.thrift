...
service VenueService {
  // 获取用户列表
    ...
    // 添加
    base.NilResponse CreatePlace(1: CreateOrUpdateVenuePlaceReq req) (api.post = "/api/idl/place/create")
    // 编辑
    base.NilResponse UpdatePlace(1: CreateOrUpdateVenuePlaceReq req) (api.post = "/api/idl/place/update")
    // 删除
    base.NilResponse PlaceUpdateStatus(1: base.StatusCodeReq req) (api.post = "/api/idl/place/status")
    // 列表
    base.NilResponse PlaceList(1: ListReq req) (api.post = "/api/idl/place/list")

     // 添加
     base.NilResponse Create(1: CreateOrUpdateVenueReq req) (api.post = "/api/idl/venue/create")
     // 编辑
     base.NilResponse Update(1: CreateOrUpdateVenueReq req) (api.post = "/api/idl/venue/update")
     base.NilResponse UpdateStatus(1: base.StatusCodeReq req) (api.post = "/api/idl/venue/status")
     // 列表
     base.NilResponse List(1: ListReq req) (api.post = "/api/idl/venue/list")
}