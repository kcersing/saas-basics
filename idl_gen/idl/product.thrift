...
service ProductService {
    // 添加属性
    base.NilResponse CreateProperty(1: CreateOrUpdatePropertyReq req) (api.post = "/api/idl/property/create")
    // 编辑属性
    base.NilResponse UpdateProperty(1: CreateOrUpdatePropertyReq req) (api.post = "/api/idl/property/update")
    // 删除属性
    base.NilResponse DeleteProperty(1: base.IDReq req) (api.post = "/api/idl/property/del")
    // 商品列表
    base.NilResponse ListProperty(1: PropertyListReq req) (api.post = "/api/idl/property/list")

    // 添加商品
    base.NilResponse Create(1: CreateOrUpdateReq req) (api.post = "/api/idl/product/create")
    // 编辑商品
    base.NilResponse Update(1: CreateOrUpdateReq req) (api.post = "/api/idl/product/update")
    // 删除商品
    base.NilResponse Delete(1: base.IDReq req) (api.post = "/api/idl/product/del")
    // 商品列表
    base.NilResponse List(1: ListReq req) (api.post = "/api/idl/product/list")
    // 上架0/下架1
    base.NilResponse UpdateStatus(1: base.StatusCodeReq req) (api.post = "/api/idl/product/status")

    // 商品详情
    base.NilResponse InfoByID(1: base.IDReq req) (api.post = "/api/idl/product/info")
