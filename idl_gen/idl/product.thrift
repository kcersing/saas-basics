...
struct ProductInfo {
    ...
    5: optional i64 stock  (api.raw = "stock")
    ...
    10: optional string deadline (api.raw = "deadline")
    11: optional string sales (api.raw = "sales")
    12: optional i64 is_sales (api.raw = "isSales")
