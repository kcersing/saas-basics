...
service TokenService{
  // 更新Token
  base.NilResponse UpdateToken(1: TokenInfo req) (api.post = "/api/idl/token/update")

  // 删除token信息
  base.NilResponse DeleteToken(1: base.IDReq req) (api.post = "/api/idl/token")

  // 获取token列表
  base.NilResponse TokenList(1: TokenListReq req) (api.post = "/api/idl/token/list")
