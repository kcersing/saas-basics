...
//  base.NilResponse Login(1: LoginReq req) (api.post = "/api/login")
  ...
  // 获取用户权限码
  base.NilResponse UserPermCode(1: base.Empty req) (api.post = "/api/idl/user/perm")

  // 修改密码
  base.NilResponse ChangePassword(1: ChangePasswordReq req) (api.post = "/api/idl/user/change-password")

  // 新增用户
  base.NilResponse CreateUser(1: CreateOrUpdateUserReq req) (api.post = "/api/idl/user/create")

  // 更新用户
  base.NilResponse UpdateUser(1: CreateOrUpdateUserReq req) (api.post = "/api/idl/user/update")

  // 获取用户基本信息
  base.NilResponse UserInfo(1: base.Empty req) (api.get = "/api/idl/user/info")

  // 获取用户列表
  base.NilResponse UserList(1: UserListReq req) (api.post = "/api/idl/user/list")

  // 删除用户信息
  base.NilResponse DeleteUser(1: base.IDReq req) (api.post = "/api/idl/user")

  // 更新用户个人信息
  base.NilResponse UpdateProfile(1: ProfileReq req) (api.post = "/api/idl/user/profile-update")

  // 获取用户个人信息
  base.NilResponse UserProfile(1: base.Empty req) (api.get = "/api/idl/user/profile")

  // 更新用户状态
  base.NilResponse UpdateUserStatus(1: base.StatusCodeReq req) (api.post = "/api/idl/user/status")

  // 设置用户角色
  base.NilResponse SetUserRole(1: SetUserRole req) (api.post = "/api/idl/user/set-role")


  base.NilResponse SetDefaultVenue(1: SetDefaultVenueReq req) (api.post = "/api/idl/user/set-default-venue")
