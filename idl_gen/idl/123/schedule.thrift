...
service ScheduleService {
    ...
    base.NilResponse MemberList(1: ScheduleMemberListReq req) (api.post = "/service/schedule/member-list")

    base.NilResponse CreateMember(1: CreateMemberReq req) (api.post = "/service/schedule/member-create")
    ...
    base.NilResponse CoachList(1: ScheduleCoachListReq req) (api.post = "/service/schedule/coach-list")
