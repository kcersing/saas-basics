...
service SysService {
    ...
    // 属性列表
    base.NilResponse PropertyList(1: base.ListReq req) (api.post = "/api/sys/property/list")

    // 属性类型
    base.NilResponse PropertyType(1: base.ListReq req) (api.post = "/api/sys/property/type")
