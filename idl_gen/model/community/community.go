...
func (p *CommunityServiceClient) ResultsUpload(ctx context.Context, req *ResultsUploadReq) (r *base.NilResponse, err error) {
	var _args CommunityServiceResultsUploadArgs
	_args.Req = req
	var _result CommunityServiceResultsUploadResult
...
func NewCommunityServiceProcessor(handler CommunityService) *CommunityServiceProcessor {
	...
	self.AddToProcessorMap("ResultsUpload", &communityServiceProcessorResultsUpload{handler: handler})
...
type communityServiceProcessorResultsUpload struct {
	handler CommunityService
}

func (p *communityServiceProcessorResultsUpload) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CommunityServiceResultsUploadArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CommunityServiceResultsUploadResult{}
	var retval *base.NilResponse
...
type CommunityServiceResultsUploadArgs struct {
	Req *ResultsUploadReq `thrift:"req,1"`
}

func NewCommunityServiceResultsUploadArgs() *CommunityServiceResultsUploadArgs {
	return &CommunityServiceResultsUploadArgs{}
}

func (p *CommunityServiceResultsUploadArgs) InitDefault() {
}

var CommunityServiceResultsUploadArgs_Req_DEFAULT *ResultsUploadReq

func (p *CommunityServiceResultsUploadArgs) GetReq() (v *ResultsUploadReq) {
	if !p.IsSetReq() {
		return CommunityServiceResultsUploadArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_CommunityServiceResultsUploadArgs = map[int16]string{
	1: "req",
}

func (p *CommunityServiceResultsUploadArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *CommunityServiceResultsUploadArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CommunityServiceResultsUploadArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CommunityServiceResultsUploadArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *CommunityServiceResultsUploadArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *CommunityServiceResultsUploadArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *CommunityServiceResultsUploadArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CommunityServiceResultsUploadArgs(%+v)", *p)

}

type CommunityServiceResultsUploadResult struct {
	Success *base.NilResponse `thrift:"success,0,optional"`
}

func NewCommunityServiceResultsUploadResult() *CommunityServiceResultsUploadResult {
	return &CommunityServiceResultsUploadResult{}
}

func (p *CommunityServiceResultsUploadResult) InitDefault() {
}

var CommunityServiceResultsUploadResult_Success_DEFAULT *base.NilResponse

func (p *CommunityServiceResultsUploadResult) GetSuccess() (v *base.NilResponse) {
	if !p.IsSetSuccess() {
		return CommunityServiceResultsUploadResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_CommunityServiceResultsUploadResult = map[int16]string{
	0: "success",
}

func (p *CommunityServiceResultsUploadResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *CommunityServiceResultsUploadResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CommunityServiceResultsUploadResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CommunityServiceResultsUploadResult) ReadField0(iprot thrift.TProtocol) error {
	_field := base.NewNilResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *CommunityServiceResultsUploadResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *CommunityServiceResultsUploadResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *CommunityServiceResultsUploadResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CommunityServiceResultsUploadResult(%+v)", *p)
