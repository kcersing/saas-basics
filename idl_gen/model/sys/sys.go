...
var SysStaffListReq_Functions_DEFAULT string = ""
...
func (p *SysStaffListReq) IsSetFunctions() bool {
	return p.Functions != SysStaffListReq_Functions_DEFAULT
}
...
func (p *SysStaffListReq) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetFunctions() {
		if err = oprot.WriteFieldBegin("functions", thrift.STRING, 3); err != nil {
			goto WriteFieldBeginError
		}
