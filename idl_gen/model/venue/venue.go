...
type VenueInfo struct {
	...
	ClassifyName  []*base.List `thrift:"classifyName,17,optional" form:"classifyName" json:"classifyName" query:"classifyName"`
}
...
var VenueInfo_Classify_DEFAULT []int64 = []int64{}
...
var VenueInfo_ClassifyName_DEFAULT []*base.List = []*base.List{}

func (p *VenueInfo) GetClassifyName() (v []*base.List) {
	if !p.IsSetClassifyName() {
		return VenueInfo_ClassifyName_DEFAULT
	}
	return p.ClassifyName
}
...
func (p *VenueInfo) IsSetClassifyName() bool {
	return p.ClassifyName != nil
}
...
func (p *VenueInfo) ReadField17(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *VenueInfo) writeField15(oprot thrift.TProtocol) (err error) {
	if p.IsSetClassify() {
		if err = oprot.WriteFieldBegin("classify", thrift.LIST, 15); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.I64, len(p.Classify)); err != nil {
			return err
...
func (p *VenueInfo) writeField17(oprot thrift.TProtocol) (err error) {
	if p.IsSetClassifyName() {
		if err = oprot.WriteFieldBegin("classifyName", thrift.LIST, 17); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.ClassifyName)); err != nil {
			return err
		}
		for _, v := range p.ClassifyName {
...
var VenuePlaceInfo_ProductIds_DEFAULT []int64 = []int64{}

func (p *VenuePlaceInfo) GetProductIds() (v []int64) {
	if !p.IsSetProductIds() {
		return VenuePlaceInfo_ProductIds_DEFAULT
	}
	return p.ProductIds
}

var VenuePlaceInfo_Products_DEFAULT []*base.List = []*base.List{}

func (p *VenuePlaceInfo) GetProducts() (v []*base.List) {
	if !p.IsSetProducts() {
		return VenuePlaceInfo_Products_DEFAULT
	}
	return p.Products
}
...
var VenuePlaceInfo_IsBooking_DEFAULT int64 = 1

func (p *VenuePlaceInfo) GetIsBooking() (v int64) {
	if !p.IsSetIsBooking() {
		return VenuePlaceInfo_IsBooking_DEFAULT
	}
	return p.IsBooking
}
...
func (p *VenuePlaceInfo) IsSetProductIds() bool {
	return p.ProductIds != nil
}

func (p *VenuePlaceInfo) IsSetProducts() bool {
	return p.Products != nil
}

func (p *VenuePlaceInfo) IsSetSeat() bool {
	return p.Seat != nil
}
...
func (p *VenuePlaceInfo) ReadField13(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *VenuePlaceInfo) ReadField14(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *VenuePlaceInfo) ReadField15(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *VenuePlaceInfo) ReadField16(iprot thrift.TProtocol) error {
...
func (p *VenuePlaceInfo) writeField13(oprot thrift.TProtocol) (err error) {
	if p.IsSetProductIds() {
		if err = oprot.WriteFieldBegin("productIds", thrift.LIST, 13); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *VenuePlaceInfo) writeField14(oprot thrift.TProtocol) (err error) {
	if p.IsSetProducts() {
		if err = oprot.WriteFieldBegin("products", thrift.LIST, 14); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *VenuePlaceInfo) writeField15(oprot thrift.TProtocol) (err error) {
	if p.IsSetSeat() {
...
func (p *VenuePlaceInfo) writeField16(oprot thrift.TProtocol) (err error) {
	if p.IsSetIsBooking() {
		if err = oprot.WriteFieldBegin("isBooking", thrift.I64, 16); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteI64(p.IsBooking); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
type VenueService interface {
	...
	/**场地詳情*/
	VenuePlaceInfo(ctx context.Context, req *base.IDReq) (r *base.NilResponse, err error)
	/**添加场馆*/
	...
	/**删除场馆信息*/
	DeleteVenue(ctx context.Context, req *base.IDReq) (r *base.NilResponse, err error)
	/**删除场地信息*/
	DeletePlace(ctx context.Context, req *base.IDReq) (r *base.NilResponse, err error)
}
...
func (p *VenueServiceClient) VenuePlaceInfo(ctx context.Context, req *base.IDReq) (r *base.NilResponse, err error) {
	var _args VenueServiceVenuePlaceInfoArgs
	_args.Req = req
	var _result VenueServiceVenuePlaceInfoResult
	if err = p.Client_().Call(ctx, "VenuePlaceInfo", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func (p *VenueServiceClient) VenueInfo(ctx context.Context, req *base.IDReq) (r *base.NilResponse, err error) {
	var _args VenueServiceVenueInfoArgs
	_args.Req = req
	var _result VenueServiceVenueInfoResult
	if err = p.Client_().Call(ctx, "VenueInfo", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VenueServiceClient) DeleteVenue(ctx context.Context, req *base.IDReq) (r *base.NilResponse, err error) {
	var _args VenueServiceDeleteVenueArgs
	_args.Req = req
	var _result VenueServiceDeleteVenueResult
	if err = p.Client_().Call(ctx, "DeleteVenue", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VenueServiceClient) DeletePlace(ctx context.Context, req *base.IDReq) (r *base.NilResponse, err error) {
	var _args VenueServiceDeletePlaceArgs
	_args.Req = req
	var _result VenueServiceDeletePlaceResult
	if err = p.Client_().Call(ctx, "DeletePlace", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewVenueServiceProcessor(handler VenueService) *VenueServiceProcessor {
	...
	self.AddToProcessorMap("VenuePlaceInfo", &venueServiceProcessorVenuePlaceInfo{handler: handler})
	...
	self.AddToProcessorMap("VenueInfo", &venueServiceProcessorVenueInfo{handler: handler})
	self.AddToProcessorMap("DeleteVenue", &venueServiceProcessorDeleteVenue{handler: handler})
	self.AddToProcessorMap("DeletePlace", &venueServiceProcessorDeletePlace{handler: handler})
	return self
}
...
type venueServiceProcessorVenuePlaceInfo struct {
	handler VenueService
}

func (p *venueServiceProcessorVenuePlaceInfo) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VenueServiceVenuePlaceInfoArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("VenuePlaceInfo", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VenueServiceVenuePlaceInfoResult{}
	var retval *base.NilResponse
	if retval, err2 = p.handler.VenuePlaceInfo(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing VenuePlaceInfo: "+err2.Error())
		oprot.WriteMessageBegin("VenuePlaceInfo", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("VenuePlaceInfo", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type venueServiceProcessorVenueInfo struct {
	handler VenueService
}

func (p *venueServiceProcessorVenueInfo) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VenueServiceVenueInfoArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VenueServiceVenueInfoResult{}
	var retval *base.NilResponse
...
type venueServiceProcessorDeleteVenue struct {
	handler VenueService
}

func (p *venueServiceProcessorDeleteVenue) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VenueServiceDeleteVenueArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("DeleteVenue", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VenueServiceDeleteVenueResult{}
	var retval *base.NilResponse
	if retval, err2 = p.handler.DeleteVenue(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing DeleteVenue: "+err2.Error())
		oprot.WriteMessageBegin("DeleteVenue", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("DeleteVenue", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type venueServiceProcessorDeletePlace struct {
	handler VenueService
}

func (p *venueServiceProcessorDeletePlace) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VenueServiceDeletePlaceArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("DeletePlace", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VenueServiceDeletePlaceResult{}
	var retval *base.NilResponse
	if retval, err2 = p.handler.DeletePlace(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing DeletePlace: "+err2.Error())
		oprot.WriteMessageBegin("DeletePlace", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("DeletePlace", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type VenueServiceVenuePlaceInfoArgs struct {
	Req *base.IDReq `thrift:"req,1"`
}

func NewVenueServiceVenuePlaceInfoArgs() *VenueServiceVenuePlaceInfoArgs {
	return &VenueServiceVenuePlaceInfoArgs{}
}

func (p *VenueServiceVenuePlaceInfoArgs) InitDefault() {
}

var VenueServiceVenuePlaceInfoArgs_Req_DEFAULT *base.IDReq

func (p *VenueServiceVenuePlaceInfoArgs) GetReq() (v *base.IDReq) {
	if !p.IsSetReq() {
		return VenueServiceVenuePlaceInfoArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_VenueServiceVenuePlaceInfoArgs = map[int16]string{
	1: "req",
}

func (p *VenueServiceVenuePlaceInfoArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *VenueServiceVenuePlaceInfoArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VenueServiceVenuePlaceInfoArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VenueServiceVenuePlaceInfoArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *VenueServiceVenuePlaceInfoArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("VenuePlaceInfo_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *VenueServiceVenuePlaceInfoArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *VenueServiceVenuePlaceInfoArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VenueServiceVenuePlaceInfoArgs(%+v)", *p)

}

type VenueServiceVenuePlaceInfoResult struct {
	Success *base.NilResponse `thrift:"success,0,optional"`
}

func NewVenueServiceVenuePlaceInfoResult() *VenueServiceVenuePlaceInfoResult {
	return &VenueServiceVenuePlaceInfoResult{}
}

func (p *VenueServiceVenuePlaceInfoResult) InitDefault() {
}

var VenueServiceVenuePlaceInfoResult_Success_DEFAULT *base.NilResponse

func (p *VenueServiceVenuePlaceInfoResult) GetSuccess() (v *base.NilResponse) {
	if !p.IsSetSuccess() {
		return VenueServiceVenuePlaceInfoResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_VenueServiceVenuePlaceInfoResult = map[int16]string{
	0: "success",
}

func (p *VenueServiceVenuePlaceInfoResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *VenueServiceVenuePlaceInfoResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VenueServiceVenuePlaceInfoResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VenueServiceVenuePlaceInfoResult) ReadField0(iprot thrift.TProtocol) error {
	_field := base.NewNilResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *VenueServiceVenuePlaceInfoResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("VenuePlaceInfo_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *VenueServiceVenuePlaceInfoResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *VenueServiceVenuePlaceInfoResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VenueServiceVenuePlaceInfoResult(%+v)", *p)
...
type VenueServiceVenueInfoArgs struct {
	Req *base.IDReq `thrift:"req,1"`
}

func NewVenueServiceVenueInfoArgs() *VenueServiceVenueInfoArgs {
	return &VenueServiceVenueInfoArgs{}
}

func (p *VenueServiceVenueInfoArgs) InitDefault() {
}

var VenueServiceVenueInfoArgs_Req_DEFAULT *base.IDReq

func (p *VenueServiceVenueInfoArgs) GetReq() (v *base.IDReq) {
	if !p.IsSetReq() {
		return VenueServiceVenueInfoArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_VenueServiceVenueInfoArgs = map[int16]string{
	1: "req",
}

func (p *VenueServiceVenueInfoArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *VenueServiceVenueInfoArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VenueServiceVenueInfoArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VenueServiceVenueInfoArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := base.NewIDReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *VenueServiceVenueInfoArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *VenueServiceVenueInfoArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *VenueServiceVenueInfoArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VenueServiceVenueInfoArgs(%+v)", *p)

}

type VenueServiceVenueInfoResult struct {
	Success *base.NilResponse `thrift:"success,0,optional"`
}

func NewVenueServiceVenueInfoResult() *VenueServiceVenueInfoResult {
	return &VenueServiceVenueInfoResult{}
}

func (p *VenueServiceVenueInfoResult) InitDefault() {
}

var VenueServiceVenueInfoResult_Success_DEFAULT *base.NilResponse

func (p *VenueServiceVenueInfoResult) GetSuccess() (v *base.NilResponse) {
	if !p.IsSetSuccess() {
		return VenueServiceVenueInfoResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_VenueServiceVenueInfoResult = map[int16]string{
	0: "success",
}

func (p *VenueServiceVenueInfoResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *VenueServiceVenueInfoResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VenueServiceVenueInfoResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VenueServiceVenueInfoResult) ReadField0(iprot thrift.TProtocol) error {
	_field := base.NewNilResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *VenueServiceVenueInfoResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *VenueServiceVenueInfoResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *VenueServiceVenueInfoResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VenueServiceVenueInfoResult(%+v)", *p)

}

type VenueServiceDeleteVenueArgs struct {
	Req *base.IDReq `thrift:"req,1"`
}

func NewVenueServiceDeleteVenueArgs() *VenueServiceDeleteVenueArgs {
	return &VenueServiceDeleteVenueArgs{}
}

func (p *VenueServiceDeleteVenueArgs) InitDefault() {
}

var VenueServiceDeleteVenueArgs_Req_DEFAULT *base.IDReq

func (p *VenueServiceDeleteVenueArgs) GetReq() (v *base.IDReq) {
	if !p.IsSetReq() {
		return VenueServiceDeleteVenueArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_VenueServiceDeleteVenueArgs = map[int16]string{
	1: "req",
}

func (p *VenueServiceDeleteVenueArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *VenueServiceDeleteVenueArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VenueServiceDeleteVenueArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VenueServiceDeleteVenueArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := base.NewIDReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *VenueServiceDeleteVenueArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("DeleteVenue_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *VenueServiceDeleteVenueArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *VenueServiceDeleteVenueArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VenueServiceDeleteVenueArgs(%+v)", *p)

}

type VenueServiceDeleteVenueResult struct {
	Success *base.NilResponse `thrift:"success,0,optional"`
}

func NewVenueServiceDeleteVenueResult() *VenueServiceDeleteVenueResult {
	return &VenueServiceDeleteVenueResult{}
}

func (p *VenueServiceDeleteVenueResult) InitDefault() {
}

var VenueServiceDeleteVenueResult_Success_DEFAULT *base.NilResponse

func (p *VenueServiceDeleteVenueResult) GetSuccess() (v *base.NilResponse) {
	if !p.IsSetSuccess() {
		return VenueServiceDeleteVenueResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_VenueServiceDeleteVenueResult = map[int16]string{
	0: "success",
}

func (p *VenueServiceDeleteVenueResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *VenueServiceDeleteVenueResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VenueServiceDeleteVenueResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VenueServiceDeleteVenueResult) ReadField0(iprot thrift.TProtocol) error {
	_field := base.NewNilResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *VenueServiceDeleteVenueResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("DeleteVenue_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *VenueServiceDeleteVenueResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *VenueServiceDeleteVenueResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VenueServiceDeleteVenueResult(%+v)", *p)

}

type VenueServiceDeletePlaceArgs struct {
	Req *base.IDReq `thrift:"req,1"`
}

func NewVenueServiceDeletePlaceArgs() *VenueServiceDeletePlaceArgs {
	return &VenueServiceDeletePlaceArgs{}
}

func (p *VenueServiceDeletePlaceArgs) InitDefault() {
}

var VenueServiceDeletePlaceArgs_Req_DEFAULT *base.IDReq

func (p *VenueServiceDeletePlaceArgs) GetReq() (v *base.IDReq) {
	if !p.IsSetReq() {
		return VenueServiceDeletePlaceArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_VenueServiceDeletePlaceArgs = map[int16]string{
	1: "req",
}

func (p *VenueServiceDeletePlaceArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *VenueServiceDeletePlaceArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VenueServiceDeletePlaceArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VenueServiceDeletePlaceArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := base.NewIDReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *VenueServiceDeletePlaceArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("DeletePlace_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *VenueServiceDeletePlaceArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *VenueServiceDeletePlaceArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VenueServiceDeletePlaceArgs(%+v)", *p)

}

type VenueServiceDeletePlaceResult struct {
	Success *base.NilResponse `thrift:"success,0,optional"`
}

func NewVenueServiceDeletePlaceResult() *VenueServiceDeletePlaceResult {
	return &VenueServiceDeletePlaceResult{}
}

func (p *VenueServiceDeletePlaceResult) InitDefault() {
}

var VenueServiceDeletePlaceResult_Success_DEFAULT *base.NilResponse

func (p *VenueServiceDeletePlaceResult) GetSuccess() (v *base.NilResponse) {
	if !p.IsSetSuccess() {
		return VenueServiceDeletePlaceResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_VenueServiceDeletePlaceResult = map[int16]string{
	0: "success",
}

func (p *VenueServiceDeletePlaceResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *VenueServiceDeletePlaceResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VenueServiceDeletePlaceResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VenueServiceDeletePlaceResult) ReadField0(iprot thrift.TProtocol) error {
	_field := base.NewNilResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *VenueServiceDeletePlaceResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("DeletePlace_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *VenueServiceDeletePlaceResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *VenueServiceDeletePlaceResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VenueServiceDeletePlaceResult(%+v)", *p)
