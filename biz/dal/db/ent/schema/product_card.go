...
func (ProductCard) Fields() []ent.Field {
	return []ent.Field{
...
func (ProductCard) Mixin() []ent.Mixin {
	return []ent.Mixin{
		mixins.BaseMixin{},
		mixins.StatusMixin{},
	}
...
func (ProductCard) Edges() []ent.Edge {
	return []ent.Edge{
...
func (ProductCard) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("id").
			Unique(),
	}
...
func (ProductCard) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "product_card", Options: "AUTO_INCREMENT = 100000"},
