...
func (ProductClass) Fields() []ent.Field {
	return []ent.Field{
...
func (ProductClass) Mixin() []ent.Mixin {
	return []ent.Mixin{
		mixins.BaseMixin{},
		mixins.StatusMixin{},
	}
...
func (ProductClass) Edges() []ent.Edge {
	return []ent.Edge{
...
func (ProductClass) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("id").
			Unique(),
	}
...
func (ProductClass) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "product_class", Options: "AUTO_INCREMENT = 100000"},
