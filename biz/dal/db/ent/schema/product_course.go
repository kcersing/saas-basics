...
func (ProductCourse) Fields() []ent.Field {
	return []ent.Field{
...
func (ProductCourse) Mixin() []ent.Mixin {
	return []ent.Mixin{
		mixins.BaseMixin{},
		mixins.StatusMixin{},
	}
...
func (ProductCourse) Edges() []ent.Edge {
	return []ent.Edge{
...
func (ProductCourse) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("id").
			Unique(),
	}
...
func (ProductCourse) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "product_course", Options: "AUTO_INCREMENT = 100000"},
