...
func (Menu) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("name").Optional().Comment("index name | 菜单名称"),
		...
		field.Int64("level").Optional().Comment("menu level | 菜单层级"),
		field.Int64("menu_type").Optional().Comment("menu type | 菜单类型 0 目录 1 菜单 2 按钮"),
		...
		//meta
		field.String("title").Optional().Comment("menu name | 菜单显示标题"),
		field.String("icon").Optional().Comment("menu icon | 菜单图标"),
