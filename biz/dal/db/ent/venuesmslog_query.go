...
func (vslq *VenueSmsLogQuery) QueryVenue() *VenueQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		schemaConfig := vslq.schemaConfig
...
func (vslq *VenueSmsLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*VenueSmsLog, error) {
	...
	_spec.Node.Schema = vslq.schemaConfig.VenueSmsLog
	ctx = internal.NewSchemaConfigContext(ctx, vslq.schemaConfig)
	for i := range hooks {
		hooks[i](ctx, _spec)
	}
...
func (vslq *VenueSmsLogQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(vslq.schemaConfig.VenueSmsLog)
	ctx = internal.NewSchemaConfigContext(ctx, vslq.schemaConfig)
