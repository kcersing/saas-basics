...
func init() {
	...
	schedulememberDescStartTime := schedulememberFields[8].Descriptor()
	...
	schedulememberDescEndTime := schedulememberFields[9].Descriptor()
	...
	schedulememberDescSignStartTime := schedulememberFields[10].Descriptor()
	...
	schedulememberDescSignEndTime := schedulememberFields[11].Descriptor()
	...
	schedulememberDescIsCourse := schedulememberFields[13].Descriptor()
