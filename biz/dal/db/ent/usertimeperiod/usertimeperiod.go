...
const (
	// Label holds the string label denoting the usertimeperiod type in the database.
	Label = "user_time_period"
	...
	EdgeUsers = "users"
	// Table holds the table name of the usertimeperiod in the database.
...
// Columns holds all SQL columns for usertimeperiod fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the UserTimePeriod queries.
