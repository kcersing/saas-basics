...
// ContestParticipantQuery is the builder for querying ContestParticipant entities.
type ContestParticipantQuery struct {
	config
	ctx         *QueryContext
	order       []contestparticipant.OrderOption
	inters      []Interceptor
...
// Where adds a new predicate for the ContestParticipantQuery builder.
func (cpq *ContestParticipantQuery) Where(ps ...predicate.ContestParticipant) *ContestParticipantQuery {
	cpq.predicates = append(cpq.predicates, ps...)
	return cpq
}

// Limit the number of records to be returned by this query.
func (cpq *ContestParticipantQuery) Limit(limit int) *ContestParticipantQuery {
	cpq.ctx.Limit = &limit
	return cpq
}

// Offset to start from.
func (cpq *ContestParticipantQuery) Offset(offset int) *ContestParticipantQuery {
...
func (cpq *ContestParticipantQuery) Unique(unique bool) *ContestParticipantQuery {
	cpq.ctx.Unique = &unique
	return cpq
}

// Order specifies how the records should be ordered.
func (cpq *ContestParticipantQuery) Order(o ...contestparticipant.OrderOption) *ContestParticipantQuery {
	cpq.order = append(cpq.order, o...)
	return cpq
}

// QueryContest chains the current query on the "contest" edge.
func (cpq *ContestParticipantQuery) QueryContest() *ContestQuery {
	query := (&ContestClient{config: cpq.config}).Query()
...
func (cpq *ContestParticipantQuery) First(ctx context.Context) (*ContestParticipant, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{contestparticipant.Label}
	}
	return nodes[0], nil
}

// FirstX is like First, but panics if an error occurs.
func (cpq *ContestParticipantQuery) FirstX(ctx context.Context) *ContestParticipant {
...
// FirstID returns the first ContestParticipant ID from the query.
...
func (cpq *ContestParticipantQuery) FirstIDX(ctx context.Context) int64 {
...
// Only returns a single ContestParticipant entity found by the query, ensuring it only returns one.
...
func (cpq *ContestParticipantQuery) Only(ctx context.Context) (*ContestParticipant, error) {
	...
	case 0:
		return nil, &NotFoundError{contestparticipant.Label}
	default:
		return nil, &NotSingularError{contestparticipant.Label}
	}
}

// OnlyX is like Only, but panics if an error occurs.
func (cpq *ContestParticipantQuery) OnlyX(ctx context.Context) *ContestParticipant {
...
// OnlyID is like Only, but returns the only ContestParticipant ID in the query.
// Returns a *NotSingularError when more than one ContestParticipant ID is found.
...
func (cpq *ContestParticipantQuery) OnlyID(ctx context.Context) (id int64, err error) {
	...
	case 0:
		err = &NotFoundError{contestparticipant.Label}
	default:
		err = &NotSingularError{contestparticipant.Label}
	}
	return
}

// OnlyIDX is like OnlyID, but panics if an error occurs.
func (cpq *ContestParticipantQuery) OnlyIDX(ctx context.Context) int64 {
...
func (cpq *ContestParticipantQuery) All(ctx context.Context) ([]*ContestParticipant, error) {
	...
	qr := querierAll[[]*ContestParticipant, *ContestParticipantQuery]()
	return withInterceptors[[]*ContestParticipant](ctx, cpq, qr, cpq.inters)
}

// AllX is like All, but panics if an error occurs.
func (cpq *ContestParticipantQuery) AllX(ctx context.Context) []*ContestParticipant {
...
// IDs executes the query and returns a list of ContestParticipant IDs.
func (cpq *ContestParticipantQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (cpq *ContestParticipantQuery) IDsX(ctx context.Context) []int64 {
	ids, err := cpq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cpq *ContestParticipantQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, cpq, querierCount[*ContestParticipantQuery](), cpq.inters)
}

// CountX is like Count, but panics if an error occurs.
func (cpq *ContestParticipantQuery) CountX(ctx context.Context) int {
...
func (cpq *ContestParticipantQuery) ExistX(ctx context.Context) bool {
...
// Clone returns a duplicate of the ContestParticipantQuery builder, including all associated steps. It can be
// used to prepare common query builders and use them differently after the clone is made.
func (cpq *ContestParticipantQuery) Clone() *ContestParticipantQuery {
	if cpq == nil {
		return nil
	}
	return &ContestParticipantQuery{
		config:      cpq.config,
		ctx:         cpq.ctx.Clone(),
		order:       append([]contestparticipant.OrderOption{}, cpq.order...),
...
func (cpq *ContestParticipantQuery) WithContest(opts ...func(*ContestQuery)) *ContestParticipantQuery {
	query := (&ContestClient{config: cpq.config}).Query()
...
//	}
//
//	client.ContestParticipant.Query().
//		GroupBy(contestparticipant.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (cpq *ContestParticipantQuery) GroupBy(field string, fields ...string) *ContestParticipantGroupBy {
	cpq.ctx.Fields = append([]string{field}, fields...)
	grbuild := &ContestParticipantGroupBy{build: cpq}
	grbuild.flds = &cpq.ctx.Fields
	grbuild.label = contestparticipant.Label
...
//
//	client.ContestParticipant.Query().
//		Select(contestparticipant.FieldCreatedAt).
//		Scan(ctx, &v)
func (cpq *ContestParticipantQuery) Select(fields ...string) *ContestParticipantSelect {
	cpq.ctx.Fields = append(cpq.ctx.Fields, fields...)
	sbuild := &ContestParticipantSelect{ContestParticipantQuery: cpq}
	sbuild.label = contestparticipant.Label
	sbuild.flds, sbuild.scan = &cpq.ctx.Fields, sbuild.Scan
	return sbuild
}

// Aggregate returns a ContestParticipantSelect configured with the given aggregations.
func (cpq *ContestParticipantQuery) Aggregate(fns ...AggregateFunc) *ContestParticipantSelect {
	return cpq.Select().Aggregate(fns...)
}

func (cpq *ContestParticipantQuery) prepareQuery(ctx context.Context) error {
...
func (cpq *ContestParticipantQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ContestParticipant, error) {
	var (
	...
	_spec.ScanValues = func(columns []string) ([]any, error) {
		return (*ContestParticipant).scanValues(nil, columns)
	}
	_spec.Assign = func(columns []string, values []any) error {
		node := &ContestParticipant{config: cpq.config}
...
func (cpq *ContestParticipantQuery) loadContest(ctx context.Context, query *ContestQuery, nodes []*ContestParticipant, init func(*ContestParticipant), assign func(*ContestParticipant, *Contest)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*ContestParticipant)
	for i := range nodes {
...
func (cpq *ContestParticipantQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(contestparticipant.Table, contestparticipant.Columns, sqlgraph.NewFieldSpec(contestparticipant.FieldID, field.TypeInt64))
	_spec.From = cpq.sql
	...
	if fields := cpq.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != contestparticipant.FieldID {
				_spec.Node.Columns = append(_spec.Node.Columns, fields[i])
			}
		}
		if cpq.withContest != nil {
			_spec.Node.AddColumnOnce(contestparticipant.FieldContestID)
		}
	}
...
func (cpq *ContestParticipantQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(cpq.driver.Dialect())
	t1 := builder.Table(contestparticipant.Table)
	columns := cpq.ctx.Fields
	if len(columns) == 0 {
		columns = contestparticipant.Columns
	}
...
type ContestParticipantGroupBy struct {
	selector
	build *ContestParticipantQuery
}

// Aggregate adds the given aggregation functions to the group-by query.
func (cpgb *ContestParticipantGroupBy) Aggregate(fns ...AggregateFunc) *ContestParticipantGroupBy {
...
func (cpgb *ContestParticipantGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ContestParticipantQuery, *ContestParticipantGroupBy](ctx, cpgb.build, cpgb, cpgb.build.inters, v)
}

func (cpgb *ContestParticipantGroupBy) sqlScan(ctx context.Context, root *ContestParticipantQuery, v any) error {
...
// ContestParticipantSelect is the builder for selecting fields of ContestParticipant entities.
type ContestParticipantSelect struct {
	*ContestParticipantQuery
	selector
}

// Aggregate adds the given aggregation functions to the selector query.
func (cps *ContestParticipantSelect) Aggregate(fns ...AggregateFunc) *ContestParticipantSelect {
...
func (cps *ContestParticipantSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ContestParticipantQuery, *ContestParticipantSelect](ctx, cps.ContestParticipantQuery, cps, cps.inters, v)
}

func (cps *ContestParticipantSelect) sqlScan(ctx context.Context, root *ContestParticipantQuery, v any) error {
