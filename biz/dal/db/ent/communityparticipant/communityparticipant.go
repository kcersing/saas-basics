...
const (
	// Label holds the string label denoting the communityparticipant type in the database.
	Label = "community_participant"
	...
	EdgeMembers = "members"
	// Table holds the table name of the communityparticipant in the database.
	Table = "community_participant"
	// CommunityTable is the table that holds the community relation/edge.
	CommunityTable = "community_participant"
...
var (
	...
	MembersPrimaryKey = []string{"member_id", "community_participant_id"}
)
...
// OrderOption defines the ordering options for the CommunityParticipant queries.
