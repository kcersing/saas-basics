...
func (su *ScheduleUpdate) SetProductID(i int64) *ScheduleUpdate {
	su.mutation.ResetProductID()
	su.mutation.SetProductID(i)
	return su
}

// SetNillableProductID sets the "product_id" field if the given value is not nil.
func (su *ScheduleUpdate) SetNillableProductID(i *int64) *ScheduleUpdate {
	if i != nil {
		su.SetProductID(*i)
	}
	return su
...
func (su *ScheduleUpdate) AddProductID(i int64) *ScheduleUpdate {
	su.mutation.AddProductID(i)
	return su
}

// ClearProductID clears the value of the "product_id" field.
func (su *ScheduleUpdate) ClearProductID() *ScheduleUpdate {
	su.mutation.ClearProductID()
	return su
}
...
func (su *ScheduleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.AddedProductID(); ok {
		_spec.AddField(schedule.FieldProductID, field.TypeInt64, value)
	}
	if su.mutation.ProductIDCleared() {
		_spec.ClearField(schedule.FieldProductID, field.TypeInt64)
	}
...
// SetProductID sets the "product_id" field.
func (suo *ScheduleUpdateOne) SetProductID(i int64) *ScheduleUpdateOne {
	suo.mutation.ResetProductID()
	suo.mutation.SetProductID(i)
	return suo
}

// SetNillableProductID sets the "product_id" field if the given value is not nil.
func (suo *ScheduleUpdateOne) SetNillableProductID(i *int64) *ScheduleUpdateOne {
	if i != nil {
		suo.SetProductID(*i)
	}
	return suo
...
// AddProductID adds i to the "product_id" field.
func (suo *ScheduleUpdateOne) AddProductID(i int64) *ScheduleUpdateOne {
	suo.mutation.AddProductID(i)
	return suo
}

// ClearProductID clears the value of the "product_id" field.
func (suo *ScheduleUpdateOne) ClearProductID() *ScheduleUpdateOne {
	suo.mutation.ClearProductID()
	return suo
}
...
func (suo *ScheduleUpdateOne) sqlSave(ctx context.Context) (_node *Schedule, err error) {
	...
	if value, ok := suo.mutation.AddedProductID(); ok {
		_spec.AddField(schedule.FieldProductID, field.TypeInt64, value)
	}
	if suo.mutation.ProductIDCleared() {
		_spec.ClearField(schedule.FieldProductID, field.TypeInt64)
	}
