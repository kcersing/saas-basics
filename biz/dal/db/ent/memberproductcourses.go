...
func (*MemberProductCourses) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case memberproductcourses.FieldID, memberproductcourses.FieldDelete, memberproductcourses.FieldCreatedID, memberproductcourses.FieldStatus, memberproductcourses.FieldMemberProductID, memberproductcourses.FieldCoursesID:
