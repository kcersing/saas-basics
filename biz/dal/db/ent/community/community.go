...
const (
	...
	// EdgeCommunityParticipants holds the string denoting the community_participants edge name in mutations.
	EdgeCommunityParticipants = "community_participants"
	// Table holds the table name of the community in the database.
	Table = "community"
	// CommunityParticipantsTable is the table that holds the community_participants relation/edge.
	CommunityParticipantsTable = "community_participant"
	// CommunityParticipantsInverseTable is the table name for the CommunityParticipant entity.
	// It exists in this package in order to avoid circular dependency with the "communityparticipant" package.
	CommunityParticipantsInverseTable = "community_participant"
	// CommunityParticipantsColumn is the table column denoting the community_participants relation/edge.
	CommunityParticipantsColumn = "community_id"
)
...
// ByCommunityParticipantsCount orders the results by community_participants count.
func ByCommunityParticipantsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newCommunityParticipantsStep(), opts...)
	}
}

// ByCommunityParticipants orders the results by community_participants terms.
func ByCommunityParticipants(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCommunityParticipantsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
func newCommunityParticipantsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CommunityParticipantsInverseTable, FieldID),
