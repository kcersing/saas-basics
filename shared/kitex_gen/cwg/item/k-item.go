...
func (p *CardProperty) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
...
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CardProperty[fieldId]), err)
SkipFieldError:
...
func (p *CardProperty) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *CardProperty) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *CardProperty) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *CardProperty) FastWrite(buf []byte) int {
	return 0
}

func (p *CardProperty) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "CardProperty")
	if p != nil {
...
func (p *CardProperty) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("CardProperty")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
		l += p.field3Length()
...
func (p *CardProperty) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "sn", thrift.STRING, 1)
...
func (p *CardProperty) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *CardProperty) fastWriteField3(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *CardProperty) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("sn", thrift.STRING, 1)
...
func (p *CardProperty) field2Length() int {
	l := 0
...
func (p *CardProperty) field3Length() int {
	l := 0
