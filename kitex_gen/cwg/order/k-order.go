...
func (p *OrderItem) DeepCopy(s interface{}) error {
	src, ok := s.(*OrderItem)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	p.OrderId = src.OrderId
	...
	if src.Address != "" {
		p.Address = kutils.StringDeepCopy(src.Address)
	}

	p.ProductId = src.ProductId

	p.StockNum = src.StockNum

	if src.ProductSnapshot != "" {
		p.ProductSnapshot = kutils.StringDeepCopy(src.ProductSnapshot)
	}
...
func (p *CancelOrderReq) DeepCopy(s interface{}) error {
	src, ok := s.(*CancelOrderReq)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *CancelOrderResp) DeepCopy(s interface{}) error {
	src, ok := s.(*CancelOrderResp)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *ListOrderReq) DeepCopy(s interface{}) error {
	src, ok := s.(*ListOrderReq)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *ListOrderResp) DeepCopy(s interface{}) error {
	src, ok := s.(*ListOrderResp)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	if src.Orders != nil {
		p.Orders = make([]*OrderItem, 0, len(src.Orders))
		for _, elem := range src.Orders {
			var _elem *OrderItem
			if elem != nil {
				_elem = &OrderItem{}
...
func (p *GetOrderByIdReq) DeepCopy(s interface{}) error {
	src, ok := s.(*GetOrderByIdReq)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *GetOrderByIdResp) DeepCopy(s interface{}) error {
	src, ok := s.(*GetOrderByIdResp)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _order *OrderItem
	if src.Order != nil {
		_order = &OrderItem{}
...
func (p *OrderServiceCreateOrderArgs) DeepCopy(s interface{}) error {
	src, ok := s.(*OrderServiceCreateOrderArgs)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *OrderServiceCreateOrderResult) DeepCopy(s interface{}) error {
	src, ok := s.(*OrderServiceCreateOrderResult)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *OrderServiceCancelOrderResult) DeepCopy(s interface{}) error {
	...
	var _success *CancelOrderResp
	if src.Success != nil {
		_success = &CancelOrderResp{}
		if err := _success.DeepCopy(src.Success); err != nil {
			return err
		}
	}
...
func (p *OrderServiceListOrderArgs) DeepCopy(s interface{}) error {
	src, ok := s.(*OrderServiceListOrderArgs)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _req *ListOrderReq
	if src.Req != nil {
		_req = &ListOrderReq{}
		if err := _req.DeepCopy(src.Req); err != nil {
			return err
...
func (p *OrderServiceListOrderResult) DeepCopy(s interface{}) error {
	src, ok := s.(*OrderServiceListOrderResult)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _success *ListOrderResp
	if src.Success != nil {
		_success = &ListOrderResp{}
		if err := _success.DeepCopy(src.Success); err != nil {
			return err
		}
	}
...
func (p *OrderServiceGetOrderByIdArgs) DeepCopy(s interface{}) error {
	src, ok := s.(*OrderServiceGetOrderByIdArgs)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _req *GetOrderByIdReq
	if src.Req != nil {
		_req = &GetOrderByIdReq{}
		if err := _req.DeepCopy(src.Req); err != nil {
			return err
		}
	}
...
func (p *OrderServiceGetOrderByIdResult) DeepCopy(s interface{}) error {
	src, ok := s.(*OrderServiceGetOrderByIdResult)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _success *GetOrderByIdResp
	if src.Success != nil {
		_success = &GetOrderByIdResp{}
		if err := _success.DeepCopy(src.Success); err != nil {
			return err
		}
	}
