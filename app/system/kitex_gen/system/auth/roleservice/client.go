...
func (p *kRoleServiceClient) RoleByID(ctx context.Context, req *base.IDReq, callOptions ...callopt.Option) (r *auth.RoleInfo, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.RoleByID(ctx, req)
}

func (p *kRoleServiceClient) RoleList(ctx context.Context, req *base.PageInfoReq, callOptions ...callopt.Option) (r []*auth.RoleInfo, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
...
func (p *kRoleServiceClient) ApiList(ctx context.Context, req *auth.ApiPageReq, callOptions ...callopt.Option) (r []*auth.ApiInfo, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ApiList(ctx, req)
}

func (p *kRoleServiceClient) ApiTree(ctx context.Context, req *auth.ApiPageReq, callOptions ...callopt.Option) (r []*base.Tree, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
