...
type PageInfoReq struct {
	...
	PageSize string `thrift:"pageSize,2" form:"pageSize" json:"pageSize" query:"pageSize"`
}
...
func (p *PageInfoReq) GetPage() (v string) {
	return p.Page
}

func (p *PageInfoReq) GetPageSize() (v string) {
	return p.PageSize
}
