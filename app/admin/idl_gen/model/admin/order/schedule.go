...
type CreateOrUpdateScheduleReq struct {
	...
	EndTime    *string  `thrift:"endTime,8,optional" form:"endTime" json:"endTime" query:"endTime"`
	Price      *float64 `thrift:"price,9,optional" form:"price" json:"price" query:"price"`
	Remark     *string  `thrift:"remark,10,optional" form:"remark" json:"remark" query:"remark"`
	MemberId   *int64   `thrift:"memberId,11,optional" form:"memberId" json:"memberId" query:"memberId"`
	CoachId    *int64   `thrift:"coachId,12,optional" form:"coachId" json:"coachId" query:"coachId"`
}
...
var CreateOrUpdateScheduleReq_EndTime_DEFAULT string

func (p *CreateOrUpdateScheduleReq) GetEndTime() (v string) {
	if !p.IsSetEndTime() {
		return CreateOrUpdateScheduleReq_EndTime_DEFAULT
	}
	return *p.EndTime
}
...
func (p *CreateOrUpdateScheduleReq) IsSetEndTime() bool {
...
func (p *CreateOrUpdateScheduleReq) writeField8(oprot thrift.TProtocol) (err error) {
	if p.IsSetEndTime() {
		if err = oprot.WriteFieldBegin("endTime", thrift.STRING, 8); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *CreateOrUpdateScheduleReq) writeField12(oprot thrift.TProtocol) (err error) {
	if p.IsSetCoachId() {
		if err = oprot.WriteFieldBegin("coachId", thrift.I64, 12); err != nil {
			goto WriteFieldBeginError
		}
