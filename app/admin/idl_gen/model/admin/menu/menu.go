...
type MenuService interface {
	...
	ApiTree(ctx context.Context, req *base.PageInfoReq) (r *base.NilResponse, err error)
	//创建菜单额外参数
...
func (p *MenuServiceClient) ApiTree(ctx context.Context, req *base.PageInfoReq) (r *base.NilResponse, err error) {
...
var MenuServiceApiTreeArgs_Req_DEFAULT *base.PageInfoReq

func (p *MenuServiceApiTreeArgs) GetReq() (v *base.PageInfoReq) {
	if !p.IsSetReq() {
