...
type CreateOrUpdateMemberReq struct {
	...
	Mobile   *string `thrift:"mobile,4,optional" form:"mobile" json:"mobile,omitempty" query:"mobile"`
	Email    *string `thrift:"email,5,optional" form:"email" json:"email,omitempty" query:"email"`
	Status   *int64  `thrift:"status,6,optional" form:"status" json:"status,omitempty" query:"status"`
	Name     *string `thrift:"name,7,optional" form:"name" json:"name,omitempty" query:"name"`
	Gender   *string `thrift:"gender,8,optional" form:"gender" json:"gender,omitempty" query:"gender"`
	Wecom    *string `thrift:"wecom,9,optional" form:"wecom" json:"wecom,omitempty" query:"wecom"`
	CreateId *int64  `thrift:"createId,10,optional" form:"createId" json:"createId,omitempty" query:"createId"`
	Birthday *string `thrift:"birthday,11,optional" form:"birthday" json:"birthday,omitempty" query:"birthday"`
}
...
type MemberProductListReq struct {
	Page     *int64  `thrift:"page,1,optional" form:"page" json:"page,omitempty" query:"page"`
	PageSize *int64  `thrift:"pageSize,2,optional" form:"pageSize" json:"pageSize,omitempty" query:"pageSize"`
	MemberId *int64  `thrift:"memberId,3,optional" form:"memberId" json:"memberId,omitempty" query:"memberId"`
	Name     *string `thrift:"name,4,optional" form:"name" json:"name,omitempty" query:"name"`
	VenueId  *int64  `thrift:"venueId,5,optional" form:"venueId" json:"venueId,omitempty" query:"venueId"`
	Status   *int64  `thrift:"status,6,optional" form:"status" json:"status,omitempty" query:"status"`
}
...
type MemberPropertyListReq struct {
	...
	VenueId         *int64  `thrift:"venueId,6,optional" form:"venueId" json:"venueId,omitempty" query:"venueId"`
	Status          *int64  `thrift:"status,7,optional" form:"status" json:"status,omitempty" query:"status"`
	MemberProductId *int64  `thrift:"memberProductId,8,optional" form:"memberProductId" json:"memberProductId,omitempty" query:"memberProductId"`
}
...
type MemberContractListReq struct {
	...
	PageSize   *int64 `thrift:"pageSize,2,optional" form:"pageSize" json:"pageSize,omitempty" query:"pageSize"`
	MemberId   *int64 `thrift:"memberId,3,optional" form:"memberId" json:"memberId,omitempty" query:"memberId"`
	VenueId    *int64 `thrift:"venueId,4,optional" form:"venueId" json:"venueId,omitempty" query:"venueId"`
	ContractId *int64 `thrift:"contractId,5,optional" form:"contractId" json:"contractId,omitempty" query:"contractId"`
}
...
type MemberProductSearchReq struct {
	Members []int64 `thrift:"members,1,optional" form:"members" json:"members,omitempty" query:"members"`
}
...
type MemberPropertySearchReq struct {
	MemberProductIds []int64 `thrift:"memberProductIds,1,optional" form:"memberProductIds" json:"memberProductIds,omitempty" query:"memberProductIds"`
}
